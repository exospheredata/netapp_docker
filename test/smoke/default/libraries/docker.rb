...
#
# NOTE: 2017-06-12
# I pulled this directly from the Inspec source code (https://github.com/chef/inspec/) since this
# Class is not available yet in the version of ChefDK that I am using:
# Chef Development Kit Version: 1.3.43
#
# This version is from Inspec release
# InSpec v1.27.0
...
class Docker < Inspec.resource(1)
  ...
  def parse_containers
    ...
    raw_containers.each_line do |entry|
      j = JSON.parse(entry)
